            ...
            SearchSection::Tracks => {
                ...
                if len > 0 {
                    let n = self
                        ...
                        .map(|i| (i + 1).min(len - 1))
                        .unwrap_or(0);
                    self.tracks_state.select(Some(n));
                }
            }
            SearchSection::Albums => {
                ...
                if len > 0 {
                    let n = self
                        ...
                        .map(|i| (i + 1).min(len - 1))
                        .unwrap_or(0);
                    self.albums_state.select(Some(n));
                }
            }
            SearchSection::Artists => {
                ...
                if len > 0 {
                    let n = self
                        ...
                        .map(|i| (i + 1).min(len - 1))
                        .unwrap_or(0);
                    self.artists_state.select(Some(n));
                }
            }
        }
    }
        ...
        match self.section {
            SearchSection::Tracks => {
                let p = self
                    ...
                    .unwrap_or(0);
                self.tracks_state.select(Some(p));
            }
            SearchSection::Albums => {
                let p = self
                    .albums_state
                    ...
                    .map(|i| i.saturating_sub(1))
                    .unwrap_or(0);
                self.albums_state.select(Some(p));
            }
            SearchSection::Artists => {
                let p = self
                    .artists_state
                    ...
                    .map(|i| i.saturating_sub(1))
                    .unwrap_or(0);
                self.artists_state.select(Some(p));
            }
        }
    }
